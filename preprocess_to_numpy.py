...
def load_datasets() -> (np.ndarray, np.ndarray, np.ndarray, np.ndarray, np.ndarray, np.ndarray):
    ...
    x_train = np.random.shuffle(np.concatenate((coma_x_train, control_x_train), axis=0))
    x_val = np.random.shuffle(np.concatenate((coma_x_val, control_x_val), axis=0))
    x_test = np.random.shuffle(np.concatenate((coma_x_test, control_x_test), axis=0))
    y_train = np.random.shuffle(np.concatenate((coma_y_train, control_y_train), axis=0))
    y_val = np.random.shuffle(np.concatenate((coma_y_val, control_y_val), axis=0))
    y_test = np.random.shuffle(np.concatenate((coma_y_test, control_y_test), axis=0))
